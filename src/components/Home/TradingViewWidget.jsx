...
const TradingViewWidget = () => {
  useEffect(() => {
    // add chart in first time
    addTradingChart();
  }, []);

  window.addEventListener("resize", () => {
    // add new chart to have correct size
    addTradingChart();
  });

  const addTradingChart = () => {
    const tradingChartContainer = document.querySelector(
      "#trading-chart-container"
    );
    if (tradingChartContainer) {
      tradingChartContainer.innerHTML = "";
    }
